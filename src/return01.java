 ...
 * @author A to Z
 */
public class return01 extends javax.swing.JFrame {
     Connection conn;
        ResultSet rl;
    ...
    {
        String sql="insert into return01"
                + "(sid,sname,father,course,branch,year,bid,name,edition,publisher,price,doi,dor)"
                + "values(?,?,?,?,?,?,?,?,?,?,?,?,?);";
        try{
        ps=conn.prepareStatement(sql);
        ps.setString(1, jTextField1.getText());
        ...
        ps.execute();
       JOptionPane.showMessageDialog(null, "details of returning book submitted");
    }
    catch(Exception e)
    {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Return panel", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 2, 24), new java.awt.Color(255, 204, 204))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      try {
       ...
       if(rl.next())
       {
           ...
           String add6=rl.getString("bid");
           jTextField7.setText(add6);
           String add7=rl.getString("bname");
           jTextField8.setText(add7);
           String add8=rl.getString("edition");
           jTextField9.setText(add8);
           String add9=rl.getString("publisher");
           jTextField10.setText(add9);
           String add10=rl.getString("price");
           ...
           JOptionPane.showMessageDialog(null, "book is not issued by this id");
      }
      catch(Exception ex)
      {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(return01.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
